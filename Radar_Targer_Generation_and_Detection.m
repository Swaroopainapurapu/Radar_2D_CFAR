...
%3. Average the summed values for all of the training cells used.
%4. After averaging convert it back to logarithimic using pow2db.
%5. Further add the offset to it to determine the threshold.
%6. Next, compare the signal under CUT with this threshold. If the CUT level > threshold assign it a value of 1, else equate it to 0.
